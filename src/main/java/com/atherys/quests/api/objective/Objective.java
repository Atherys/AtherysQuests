 ...
 * Objectives are copyable objects. When a {@link Quester} picks up a new Quest, the Quest object, along with all of it's member variables ( including Objectives ), are copied and stored on to the SimpleQuester object.<br>
