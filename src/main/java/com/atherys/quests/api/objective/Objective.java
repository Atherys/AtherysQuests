 ...
 * Objectives are copyable objects. When a {@link Quester} picks up a new Quest, the completedQuest object, along with all of it's member variables ( including Objectives ), are copied and stored on to the Quester object.<br>
