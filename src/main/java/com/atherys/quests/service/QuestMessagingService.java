...
public class QuestMessagingService {
    ...
    public void error(MessageReceiver receiver, Object... msg) {
        receiver.sendMessage(Text.of(MSG_PREFIX, TextColors.RED, " ", Text.of(msg)));
    }
    ...
    public void info(MessageReceiver receiver, Object... msg) {
        receiver.sendMessage(Text.of(MSG_PREFIX, TextColors.GREEN, " ", Text.of(msg)));
    }
