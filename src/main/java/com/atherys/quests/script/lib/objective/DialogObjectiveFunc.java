 ...
 * @jsfunc
 */
public class DialogObjectiveFunc implements ScriptTriFunction<String, Integer, Text, Objective> {
    /**
     ...
     */
    @Override
    public Objective call(String treeId, Integer dialogNode, Text description) {
